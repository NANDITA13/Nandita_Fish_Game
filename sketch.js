...
function preload() {
  ...
  energySound = loadSound ("images/fantastic.mp3");
  winSound = loadSound ("images/wow-amazing.mp3");
  plasticHitSound = loadSound ("images/oh no 3.mp3");
  gameOverSound = loadSound ("images/yoyo_death.mp3");
